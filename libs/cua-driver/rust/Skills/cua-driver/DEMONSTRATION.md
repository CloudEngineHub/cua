...
> The cua-driver analog of OpenAI Codex Record & Replay. Record a human (or
...
This is the same format OpenAI Codex Record & Replay emits. Write a single
`SKILL.md`:
...
`~/.claude/skills/<name>/`, Codex `~/.agents/skills/<name>/`). The recording's
