...
> **Windows only for now** (macOS/Linux planned). This is the cua-driver
> analog of OpenAI Codex Record & Replay: record a human demonstrating a
> task on a window, then turn it into a reusable skill.
